...
#NOTE : need a DF
val_data = pd.read_csv('data/playlist_features_filtered.csv', sep = ',', index_col= 0)
val_data = preprocessing_pipeline(val_data)

df = val_data[['name','acousticness','danceability','duration_ms','energy','instrumentalness','key,liveness','loudness','mode','speechiness','tempo','time_signature','valence']]
